...
#define ARDUINO_INSTANCE_ID 0x100
...
/**
 * @brief check all the active digital inputs for change of state, then add any events
...
// -----------------------------------------------------------------------------
/**
 * @brief sets the pin mode to the correct state and sets the relevant bits in the
...
/**
 * @brief Sets the value of an individual pin. Useful if you want to set a pin value but
 *        are not tracking the digital port state.
 * @param pin The pin to set the value of.
 * @param value The value to set the pin to.
 * 
 * @details Can only be used on pins configured as OUTPUT.
